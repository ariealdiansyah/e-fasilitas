									...
									<table class="table table-hover m-t-10">
										...
										<tbody>
											<tr v-if="item.length < 1">
												<td class="text-center" colspan="6">item tidak tersedia</td>
											</tr>
					...
					<form class="form-horizontal" v-on:submit.prevent="validate" enctype="multipart/form-data">
						<div class="modal-body">
							<div class="col-md-12">
								...
								<div class="form-group" :class="{'has-error': errors.has('idLokasi') }">
									<label for="idLokasi" class="col-sm-3 control-label">Lokasi</label>
									<div class="col-sm-9">
										<select name="idLokasi" v-model="temp.idLokasi" class="form-control" v-validate="'required'">
										...
										<div class="text-left">
											<span v-show="errors.has('idLokasi')" class="text-danger">{{ errors.first('idLokasi') }}</span>
										</div>
									</div>
								</div>
